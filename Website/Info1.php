...
//_______________________________________________________________________________________
    ...
    $query = "SELECT data, time_stamp FROM HardwareDataTest WHERE identifier = 'P' and node = 'Node 1' ORDER BY 'time_stamp'";
    $result = mysqli_query($connect, $query);
    $chart_data = '';
    ...
    $query = "SELECT data, time_stamp FROM HardwareDataTest WHERE identifier = 'T' and node = 'Node 1' ORDER BY 'time_stamp'";
    $result = mysqli_query($connect, $query);
    $chart_data = '';
