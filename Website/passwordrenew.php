...
//_______________________________________________________________________________________
        ...
        if (strcmp($password_new, $passwordcheck_new) !== 0) 
        {
            ...
            $master= 0;
            header('Location: http://markuspi.bulme.at/admin/passwordnew.php');
        }
        ...
        else
        {
            ...
            if($password_db = "0")
            {
                //password hasn´t been deleted so it has to be deleted first
                $master = 0;
                header('Location: http://markuspi.bulme.at/admin/passwordnew.php');
            }
            else
            {
                //password has been deleted new one can be entered
                $master = 1;
            }
