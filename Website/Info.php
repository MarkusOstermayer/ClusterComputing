...
//_______________________________________________________________________________________
    ...
    $query = "SELECT data, time_stamp FROM HardwareDataTest WHERE identifier = 'P' and node = 'MasterNode' ORDER BY 'time_stamp'";
    $result = mysqli_query($connect, $query);
    $chart_data = '';
    ...
    $query = "SELECT data, time_stamp FROM HardwareDataTest WHERE identifier = 'T' and node = 'MasterNode' ORDER BY 'time_stamp'";
    $result = mysqli_query($connect, $query);
    $chart_data = '';
        	...
        	<div class="col-lg-4 col-xs-6">
          	<!-- small box -->
          		<div class="small-box bg-gray">
					...
					<p class="row"></p>
                    <h2 class="fa fa-cogs">	Type: Raspberry Pi 3</h2> 
					<p class="row"></p>
            ...
            <div class="col-lg-4 col-xs-6">
          	<!-- small box -->
          		<div class="small-box bg-yellow">
					...
					<h2 class="fa fa-signal">  Prozessor:   BCM2837 64 Bit ARMv8</h2>
					<p class="row"></p>
					<h2 class="fa fa-circle-o-notch">	 Taktrate: 1,2GHz</h2> 
					<p class="row"></p>
